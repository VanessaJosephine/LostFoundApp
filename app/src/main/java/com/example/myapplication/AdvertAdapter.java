...
public class AdvertAdapter extends RecyclerView.Adapter<AdvertAdapter.MyViewHolder>{
    ...
    @NonNull
    @Override
    public AdvertAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdvertAdapter.MyViewHolder holder, int position) {
